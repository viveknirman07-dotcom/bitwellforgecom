 ...
 */
const VaultLink = forwardRef<HTMLAnchorElement, Props>(
  ({ to, children, className = "", onClick, ...rest }, ref) => {
    ...
    return (
      <a ref={ref} href={to} onClick={handle} className={`vault-activate ${className}`} {...rest}>
        {children}
      </a>
    );
  }
...
VaultLink.displayName = "VaultLink";
