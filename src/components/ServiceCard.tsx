...
const ServiceCard = ({ title, description, href, index }: ServiceCardProps) => {
  return (
    <Link
      to={href}
      className="group block p-8 md:p-10 rounded-2xl border border-border/60 bg-card/60 backdrop-blur-xl hover:bg-card/80 hover:shadow-[0_8px_30px_hsl(var(--foreground)/0.06)] hover:-translate-y-1.5 hover:border-accent/30 active:scale-[0.99] transition-all duration-500"
