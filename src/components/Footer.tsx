        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-10">
          ...
          <motion.div className="md:col-span-4" {...fade(0.24)}>
            ...
            <Link
              ...
              className="group inline-flex items-center gap-2 bg-gold text-navy px-6 py-3.5 rounded-full text-[13px] font-semibold tracking-wide transition-all duration-300 hover:-translate-y-0.5 hover:bg-gold/90 hover:shadow-[0_12px_40px_hsl(38_38%_60%/0.35)]"
            >
